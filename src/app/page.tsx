...
export default function DashboardPage() {
    ...
    return (
      <div className="max-w-6xl mx-auto animate-fade-in">
        <div className="card p-16 flex flex-col items-center justify-center text-center">
          ...
          <button onClick={fetchStats} className="btn-accent">Tentar novamente</button>
        </div>
      </div>
    );
  }
  ...
  const totalInPipeline = stats.pipeline
  ...
  return (
    <div className="max-w-6xl mx-auto animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
        ...
        <div className="card p-6">
          <div className="flex items-center justify-between mb-4">
            <p className="text-label text-text-tertiary">Posts este Mes</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="card p-6">
          <div className="flex items-center justify-between mb-4">
            <p className="text-label text-text-tertiary">Mix de Conteudo</p>
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-accent-surface">
